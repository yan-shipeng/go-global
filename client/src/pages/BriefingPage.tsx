  ...
  const groups = [
    {
      ...
      actions: [
        ...
        { name: "争取总部公开背书", cost: "2 资源", type: "政治", desc: "通过公开支持提升你的正当性。首次背书信号最强；反复求背书会逐渐消耗与CEO的政治资本，边际效果递减。" },
        { name: "休闲聚会", cost: "2 资源", type: "关系", desc: "饭局、喝酒——在非正式场合建立信任。每次最多邀请四人，有冷却期。对已有初步理解的人效果显著；参与者之间若有正式关系，效果额外增强；有已转化同事参与时，口碑扩散至其关系邻居，效果更强，还可自然了解参与者之间的关系网络。过度使用后效果打折，可信度受损。" },
      ],
    },
    {
      label: "💬 对话与沟通",
      ...
      actions: [
        { name: "私人访谈", cost: "2 资源", type: "对话", desc: "深度私人对话，一次访谈即可全面解锁对方的动作偏好与隐藏关系网络（休闲聚会也能部分揭露隐藏关系）。每次可访谈一至两人，但同时约谈两人时每人获得的深度关注相对减少，推进效果略低于单独访谈。对同一人过度访谈会显得烦人，引发反感。有冷却期。" },
    ...
    },
    {
      ...
      actions: [
        ...
        { name: "小范围试点", cost: "3 资源", type: "验证", desc: "把抽象的变革要求变成可以看得见、摸得着的实际成果，最能说服眼见为实的人，扩散效果强。需选定若干参与者。" },
        { name: "讲述成功案例", cost: "1 资源", type: "叙事", desc: "用真实案例激励目标，强化变革可行性的信念。没有任何转化成果时强行讲故事，听众会主动抵触。反复讲述同类案例会产生故事疲劳，多次使用后效果递减。" },
      ],
    },
    {
      label: "🏆 认可与压力",
      ...
      actions: [
        { name: "公开认可示范者", cost: "2 资源", type: "政治", desc: "公开表彰有实际成果的人，放大示范效应。目标必须已处于参与状态或以上；表彰火候未到的人会引发全组织质疑。" },
        { name: "宣布KPI与时限", cost: "2 资源", type: "压力", desc: "能制造紧迫感，但组织也会感到压力。若你的信誉尚未建立且缺乏真实成果，硬推KPI会被认为是蛮干而引发反弹。" },
